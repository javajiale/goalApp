...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static String DB_PATH        = "/data/data/com.javajiale.goalapp/databases/";


    private static String DB_NAME         = "goal.db";
    ...
    public  void  createDatabase(Context context) throws IOException {
        try {
            ...
            if (!(new File(databaseFilename)).exists()) {
                ...
                InputStream is = context.getResources().openRawResource(R.raw.goal);
    ...
    public boolean deleteDatabase(Context context) {
        return context.deleteDatabase("acc.db");
    }
}
